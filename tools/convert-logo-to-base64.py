...
def convert_image_to_base64(source_path, output_js_path, target_width=80):
    """
    Convert PNG image to base64 data URL for PDFMake
    ...
    try:
        ...
        # Also save the white-bg version as a file for reference
        white_bg_path = source_path.parent / 'FVU-logo-white-bg.png'
        img.save(white_bg_path, 'PNG', optimize=True)
        print(f"  Saved white-bg version: {white_bg_path.name}")
 ...
 * Source: {source_path.name} (flattened to white background)
...
'''
        ...
        print(f"  Original mode: {original_mode} -> RGB (white background)")
